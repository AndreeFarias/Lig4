...
public class InterfaceMenu extends javax.swing.JFrame {
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        //Se nenhum dos campos de texto estiver vazio
        if (!jTextField1.getText().isBlank() && !jTextField2.getText().isBlank()) {
            //Definir jogadores e partida
            Lig4.confirmarJogadores(jTextField1.getText(), jTextField2.getText());
            //Mostrar jogo
            Lig4.abrirJogo();
            //Informar que jogador começa
            Lig4.ij.iniciarJogo(jTextField1.getText());
        }
